...
public class DeltaLogisticoEstocastico extends Delta {

	private static Logger logger = Logger.getLogger(DeltaLogisticoEstocastico.class);

	public DeltaLogisticoEstocastico(Config c) throws ConvergenceException {
		super(c);
	}
