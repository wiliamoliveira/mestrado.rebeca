...
public class TaskGenerateFExponencial extends TaskF {

	public TaskGenerateFExponencial(Config c, Opcao o) {
		super(c, o);
	}
	...
	public double calculaFijk(int i, int j, int k, double qStar) throws ConvergenceException {
		// para pegar o valor de growth rate: c.getGrowthRate()
		...
		if ((j == o.getMaxStepE() - 1) && (i == o.getMaxStepP() - 1)) {
			...
			double pjtermo2 = ((c.getGrowthRate() * j * o.getDeltaE()) - qStar) / o.getDeltaE();
	...
	public String taskName() {
		return "Calculating F Exponencial...";
	}
}
